...
int main(void)
{
  ...
  mainScreen.setLineVal("Ñèãíàëû ÒÑ/ÒÓ", &tsTyScreen);
  mainScreen.setLineVal("Èçìåðåíèÿ", &measurementsScreen);
  mainScreen.setLineVal("Æóðíàë ñîáûòèé", &eventScreen);
  mainScreen.setLineVal("Íàñòðîéêè", &settingsScreen);
  mainScreen.setLineVal("Date", &dateScreen);

  tsTyScreen.setLineVal("1.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("2.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("3.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("4.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("5.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("6.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("7.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("8.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("9.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("10.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("11.ÒÑ/ÒÓ", &tsTyScreen);
  tsTyScreen.setLineVal("12.ÒÑ/ÒÓ", &tsTyScreen);

  measurementsScreen.setLineVal("1.ÒÈ", &tsTyScreen);
  measurementsScreen.setLineVal("2.ÒÈ", &tsTyScreen);
  measurementsScreen.setLineVal("3.ÒÈ", &tsTyScreen);

  eventScreen.setLineVal("Ñîáûòèÿ ÒÑ", &tsTyScreen);
  eventScreen.setLineVal("Ñîáûòèÿ ÒÓ", &tsTyScreen);

  settingsScreen.setLineVal("Ïðîâåðêà LED", &tsTyScreen);
  settingsScreen.setLineVal("Ïðîâåðêà ÒÓ", &tsTyScreen);

  dateScreen.setLineVal("date1", &tsTyScreen);
